                        ...
                        /**************************si la persona existe y trae codigo de libro ***************************/
                             if (is_numeric($cod_libro)){
                                   ...
                                   if ($user->estatus){
                                    ...
                                    $persona->editar($persona->datos[0]['identificacion'],$persona->datos[0]['id_estado'],$persona->datos[0]['id_ciudad'],
                                                    $persona->datos[0]['nombre'],$persona->datos[0]['apellido'], $persona->datos[0]['telefono'],$persona->datos[0]['$telefono2'],
                                                    $persona->datos[0]['$correo'],$persona->datos[0]['$correo2']  ,$persona->datos[0]['$fecha_nacimiento'],
                                                    $persona->datos[0]['$direccion'],$persona->datos[0]['$modificado'] ,  $persona->datos[0]['$id_grupo'],
                                                    $cod_libro);
